      ...
      <div class="col-lg-8">
        <div class="card shadow">
          <div class="card-header border-0">
            <h3 class="mb-0">Edit Sub Kategori Download</h3>
          </div>
          <div class="card-body">
            ...
            <form action="<?= base_url('subkategoridownload/update/' . $sub_kategori['id_sub_kategori_download']) ?>" method="POST">
              <?= csrf_field() ?>
                ...
                <select class="form-control" id="id_kategori_download" name="id_kategori_download" required>
                  ...
                  <?php foreach ($kategoris as $kategori): ?>
                    <option value="<?= $kategori['id_kategori_download'] ?>" 
                            <?= (old('id_kategori_download', $sub_kategori['id_kategori_download']) == $kategori['id_kategori_download']) ? 'selected' : '' ?>>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nama_sub_kategori_download" name="nama_sub_kategori_download" 
                       value="<?= old('nama_sub_kategori_download', $sub_kategori['nama_sub_kategori_download']) ?>" 
              ...
              <div class="form-group">
                <label class="form-control-label">Informasi</label>
                <div class="row">
                  <div class="col-md-6">
                    <small class="text-muted">
                      <strong>Kategori Induk:</strong> <?= esc($sub_kategori['nama_kategori_download']) ?>
                    </small>
                  </div>
                  <div class="col-md-6">
                    <small class="text-muted">
                      <strong>Dibuat:</strong> <?= date('d/m/Y H:i', strtotime($sub_kategori['created_at'])) ?>
                    </small>
                  </div>
                </div>
              </div>
