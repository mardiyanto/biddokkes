      ...
      <div class="col-xl-12">
        <div class="card shadow">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <form method="post" enctype="multipart/form-data" action="<?= base_url('halaman/update/'.$halaman['id_halaman']) ?>" id="form-halaman">
              <?= csrf_field() ?>
              <div class="form-group">
                <label>Judul Halaman <span class="text-danger">*</span></label>
                <input type="text" name="judul" class="form-control" value="<?= old('judul', $halaman['judul']) ?>" required maxlength="200" placeholder="Masukkan judul halaman">
              </div>
              <div class="form-group">
                <label>Slug</label>
                <input type="text" class="form-control" value="<?= esc($halaman['slug']) ?>" readonly>
                <small class="form-text text-muted">Slug akan otomatis di-generate dari judul halaman.</small>
              </div>
              <div class="form-group">
                <label>Penulis <span class="text-danger">*</span></label>
                <input type="text" name="penulis" class="form-control" value="<?= old('penulis', $halaman['penulis']) ?>" required maxlength="100" placeholder="Masukkan nama penulis">
              </div>
              <div class="form-group">
                <label>Tanggal Publish <span class="text-danger">*</span></label>
                <input type="date" name="tanggal_publish" class="form-control" value="<?= old('tanggal_publish', $halaman['tanggal_publish']) ?>" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div id="dropzone-gambar" class="dropzone-halaman" style="border:2px dashed #ccc;padding:20px;text-align:center;cursor:pointer;border-radius:5px;">
                  ...
                  <div id="preview-gambar" style="margin-top:10px;">
                    <?php if ($halaman['gambar']): ?>
                      <img src="<?= base_url('uploads/halaman/'.$halaman['gambar']) ?>" alt="Gambar" width="120" class="img-thumbnail">
                    <?php endif; ?>
                  </div>
                </div>
              ...
              <div id="progress-container" style="display:none;">
                ...
                <small class="text-muted">Mengupdate halaman...</small>
              </div>
