      ...
      <div class="col-xl-12">
        <div class="card shadow">
          <div class="card-header border-0">
            <h3 class="mb-0">Tambah File Download</h3>
          </div>
          <div class="card-body">
            ...
            <form action="<?= base_url('download/store') ?>" method="post" enctype="multipart/form-data" id="formDownload">
              <?= csrf_field() ?>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control <?= (session()->getFlashdata('errors.deskripsi')) ? 'is-invalid' : '' ?>" 
                          ...
                          placeholder="Masukkan deskripsi file download" required><?= old('deskripsi') ?></textarea>
              ...
              <div class="form-group">
                ...
                <div id="dropzone-file" class="dropzone-download <?= (session()->getFlashdata('errors.file')) ? 'is-invalid' : '' ?>" 
                  ...
                  <div id="dropzone-text">
                    ...
                    <h5>Seret file ke sini atau klik untuk memilih file</h5>
...
$(document).ready(function() {
    ...
    preview.html(`
      <div class="alert alert-success">
        <div class="d-flex align-items-center">
          <i class="fas fa-file-${fileIcon} fa-2x text-primary mr-3"></i>
          <div>
            <strong>${file.name}</strong><br>
            <small class="text-muted">Ukuran: ${fileSize} | Tipe: ${fileExtension.toUpperCase()}</small>
          </div>
        </div>
      </div>
    `);
  ...
  $('#formDownload').validate({
    ...
    submitHandler: function(form) {
      ...
      // Simulasi progress bar (karena form biasa tidak bisa track progress)
      var progress = 0;
        ...
        success: function(response) {
          ...
          if (response.success && response.data.length > 0) {
            ...
            $.each(response.data, function(index, subKategori) {
              subKategoriSelect.append('<option value="' + subKategori.id_sub_kategori_download + '">' + subKategori.nama_sub_kategori_download + '</option>');
            });
          } else {
