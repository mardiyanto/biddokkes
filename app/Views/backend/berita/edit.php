      ...
      <div class="col-xl-12">
        <div class="card shadow">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <form method="post" enctype="multipart/form-data" action="<?= base_url('berita/update/'.$berita['id_berita']) ?>">
              <?= csrf_field() ?>
              ...
              <div class="form-group">
                ...
                <select name="id_kategori" class="form-control" required>
                  ...
                  <?php foreach ($kategori as $kat): ?>
                    <option value="<?= $kat['id_kategori'] ?>" <?= old('id_kategori', $berita['id_kategori']) == $kat['id_kategori'] ? 'selected' : '' ?>>
              ...
              <div class="form-group">
                ...
                <input type="date" name="tanggal_terbit" class="form-control" value="<?= old('tanggal_terbit', $berita['tanggal_terbit']) ?>" required>
              </div>
              <div class="form-group">
                ...
                <div id="dropzone-gambar" class="dropzone-berita" style="border:2px dashed #ccc;padding:20px;text-align:center;cursor:pointer;border-radius:5px;">
                  ...
                  <div id="preview-gambar" style="margin-top:10px;">
                    <?php if ($berita['gambar']): ?>
                      <img src="<?= base_url('uploads/artikel/'.$berita['gambar']) ?>" alt="Gambar" width="120" class="img-thumbnail">
                    <?php endif; ?>
                  </div>
                </div>
